...
public class ElectricalCapacitance extends DoubleScalarRel<ElectricalCapacitanceUnit, ElectricalCapacitance>
{
    ...
    /**
     * Construct ElectricalCapacitance scalar with a unit.
    ...
    /**
     * Construct ElectricalCapacitance scalar based on an SI value.
     ...
     * @return a ElectricalCapacitance at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type ElectricalCapacitance.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of ElectricalCapacitance
     */
    public static ElectricalCapacitance multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                ...
                "Multiplying %s by %s does not result in instance of type ElectricalCapacitance", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new ElectricalCapacitance(scalar1.si * scalar2.si, ElectricalCapacitanceUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type ElectricalCapacitance.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of ElectricalCapacitance
     */
    public static ElectricalCapacitance divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(ElectricalCapacitanceUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class,
                "Dividing %s by %s does not result in an instance of type ElectricalCapacitance", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new ElectricalCapacitance(scalar1.si / scalar2.si, ElectricalCapacitanceUnit.SI);
    }
