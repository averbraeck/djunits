...
public class ElectricalInductance extends Quantity<ElectricalInductance>
{
     ...
     */
    public ElectricalInductance(final double valueInUnit, final String abbreviation)
    {
        this(valueInUnit, Units.resolve(ElectricalInductance.Unit.class, abbreviation));
    }
