...
public class Torque extends DoubleScalarRel<TorqueUnit, Torque>
{
    ...
    /**
     * Construct Torque scalar with a unit.
    ...
    /**
     * Construct Torque scalar based on an SI value.
     ...
     * @return a Torque at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type Torque.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of Torque
     */
    public static Torque multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type Torque",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new Torque(scalar1.si * scalar2.si, TorqueUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type Torque.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of Torque
     */
    public static Torque divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .minus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(TorqueUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type Torque",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new Torque(scalar1.si / scalar2.si, TorqueUnit.SI);
    }
