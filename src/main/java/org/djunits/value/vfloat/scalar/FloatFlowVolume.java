...
public class FloatFlowVolume extends FloatScalarRel<FlowVolumeUnit, FloatFlowVolume>
{
    ...
    public static FloatFlowVolume valueOf(final String text)
    {
        ...
        catch (Exception exception)
        {
            throw new IllegalArgumentException(
                    "Error parsing FloatFlowVolume from " + text + " using Locale " + Locale.getDefault(Locale.Category.FORMAT),
                    exception);
        }
    }
    ...
    public static FloatFlowVolume of(final float value, final String unitString)
    {
        ...
        FlowVolumeUnit unit = FlowVolumeUnit.BASE.getUnitByAbbreviation(unitString);
        Throw.when(unit == null, IllegalArgumentException.class, "Error parsing FloatFlowVolume with unit %s", unitString);
        return new FloatFlowVolume(value, unit);
    }
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatFlowVolume.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatFlowVolume
     */
    public static FloatFlowVolume multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type FloatFlowVolume",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatFlowVolume(scalar1.si * scalar2.si, FlowVolumeUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatFlowVolume.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatFlowVolume
     */
    public static FloatFlowVolume divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .minus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(FlowVolumeUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type FloatFlowVolume",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatFlowVolume(scalar1.si / scalar2.si, FlowVolumeUnit.SI);
    }
