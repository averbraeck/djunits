...
public class IlluminanceUnitTest extends AbstractLinearUnitTest<Illuminance.Unit>
{
    ...
    {
        Illuminance.Unit myUnit = Illuminance.Unit.SI.deriveUnit("my", "my", "myIlluminance", 1.23, UnitSystem.OTHER, null);
    ...
    final void testStandardMethods()
    {
        ...
        Illuminance.Unit nonlinearUnit = new Illuminance.Unit("xx", "xx", "xx", new GradeScale(0.1), UnitSystem.OTHER, null);
