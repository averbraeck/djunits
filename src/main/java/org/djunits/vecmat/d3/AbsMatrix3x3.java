 ...
 */
public class AbsMatrix3x3<A extends AbsBasic<A, Q, ?>, Q extends Quantity<Q>>
        extends AbsSquareMatrix<A, Q, AbsMatrix3x3<A, Q>, Matrix3x3<Q>>
{
     ...
     */
    public static <A extends AbsBasic<A, Q, R>, Q extends Quantity<Q>, R extends Reference<R, A, Q>> AbsMatrix3x3<A, Q> of(
     ...
     * @param <R> the reference type
     */
    public static <A extends AbsBasic<A, Q, R>, Q extends Quantity<Q>, R extends Reference<R, A, Q>> AbsMatrix3x3<A, Q> ofSi(
