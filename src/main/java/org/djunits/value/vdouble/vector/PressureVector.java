...

{
    ...
    /* CONSTRUCTORS WITH Map<Integer, Double> or Map<Integer, Pressure> */
     ...
     * @param data Map&lt;Integer, Double&gt; or Map&lt;Integer, Pressure&gt;; the data for the vector
     * @param size int; the size off the vector, i.e., the highest index
     * @param displayUnit PressureUnit; the display unit of the vector data, and the unit of the data points when the data is
     *            expressed as List&lt;Double&gt; or List&lt;Number&gt; in general
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public PressureVector(final Map<Integer, ? extends Number> data, final int size, final PressureUnit displayUnit,
            final StorageType storageType)
    {
        this(data.size() == 0 ? DoubleVectorData.instantiate(data, size, IdentityScale.SCALE, storageType)
                : data.values().iterator().next() instanceof Pressure
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public PressureVector(final Map<Integer, ? extends Number> data, final int size, final StorageType storageType)
    {
     ...
     * @param size int; the size off the vector, i.e., the highest index
     */
    public PressureVector(final Map<Integer, ? extends Number> data, final int size)
    {
