...
public class Torque extends Quantity.Relative<Torque, Torque.Unit>
{
     ...
     * @author Alexander Verbraeck
     */
    public static class Unit extends AbstractUnit<Torque.Unit>
    {
        ...
        /** Gray. */
        public static final Torque.Unit GRAY = new Torque.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final Torque.Unit SI = GRAY;

        /** mGy. */
        public static final Torque.Unit MILLIGRAY =
                new Torque.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final Torque.Unit MICROGRAY =
                new Torque.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final Torque.Unit ERG_PER_GRAM =
                new Torque.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final Torque.Unit RAD = new Torque.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Torque.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
