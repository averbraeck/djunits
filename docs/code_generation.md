...
* `GenerateCliConvertersTest`: this program writes to the console. When new units have been added, this generator needs to be augmented with tests for those new units. This output should be copied and inserted in `CliUnitConverters` in two parts.
