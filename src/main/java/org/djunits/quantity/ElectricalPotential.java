...
public class ElectricalPotential extends Quantity.Relative<ElectricalPotential, ElectricalPotential.Unit>
{
    ...
    public static class Unit extends AbstractUnit<ElectricalPotential.Unit>
    {
        ...
        /** Gray. */
        public static final ElectricalPotential.Unit GRAY = new ElectricalPotential.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);
        ...
        /** &#181;Gy. */
        public static final ElectricalPotential.Unit MICROGRAY =
                new ElectricalPotential.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new ElectricalPotential.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
