...
public class Pressure extends Quantity.Relative<Pressure, Pressure.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Pressure.Unit>
    {
        ...
        /** Gray. */
        public static final Pressure.Unit GRAY = new Pressure.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final Pressure.Unit SI = GRAY;

        /** mGy. */
        public static final Pressure.Unit MILLIGRAY =
                new Pressure.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final Pressure.Unit MICROGRAY =
                new Pressure.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final Pressure.Unit ERG_PER_GRAM =
                new Pressure.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final Pressure.Unit RAD = new Pressure.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Pressure.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
