        ...
        M extends FloatMatrix<U, S, V, M>> extends Matrix<U, S, V, FloatVectorData, M, FloatMatrixData>
{
    ...
    private static final Map<Unit<?>, Constructor<? extends FloatMatrix<?, ?, ?, ?>>> CACHE_DATA = new HashMap<>();
    ...
    public static <U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>,
            M extends FloatMatrix<U, S, V, M>> M instantiate(final float[][] valuesInUnit, final U unit,
     ...
     */
    public static <U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>,
            M extends FloatMatrix<U, S, V, M>> M instantiateSI(final float[][] valuesSI, final U displayUnit,
                    final StorageType storageType)
    {
     ...
     */
    public static <U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>,
            M extends FloatMatrix<U, S, V, M>> M instantiate(final FloatMatrixData values, final U unit)
    {
     ...
     */
    public static <U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>,
            M extends FloatMatrix<U, S, V, M>> M instantiate(final S[][] values, final U displayUnit,
                    final StorageType storageType)
    {
     ...
     */
    public static <U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>,
            M extends FloatMatrix<U, S, V, M>> M instantiate(final Collection<FloatSparseValue<U, S>> values,
    ...
    @SuppressWarnings("unchecked")
    public static <U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>,
            M extends FloatMatrix<U, S, V, M>> M instantiateAnonymous(final FloatMatrixData values, final Unit<?> unit)
    {
        try
        {
            Constructor<? extends FloatMatrix<?, ?, ?, ?>> matrixConstructor = CACHE_DATA.get(unit);
            if (matrixConstructor == null)
            {
                ...
                {
                    matrixClass =
                            (Class<FloatMatrix<?, ?, ?, ?>>) Class.forName("org.djunits.value.vfloat.matrix.Float"
        ...
        {
            throw new UnitRuntimeException("Cannot instantiate FloatMatrix of unit " + unit.toString() + ". Reason: "
