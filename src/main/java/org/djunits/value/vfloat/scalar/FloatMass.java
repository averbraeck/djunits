...
public class FloatMass extends FloatScalarRel<MassUnit, FloatMass>
{
    ...
    /**
     * Construct FloatMass scalar with a unit.
    ...
    /**
     * Construct FloatMass scalar with a unit using a double value.
    ...
    /**
     * Construct FloatMass scalar based on an SI value.
     * @param value the float value in SI units
     * @return the new scalar with the SI value
     */
    public static final FloatMass ofSI(final float value)
    {
     ...
     * @return a FloatMass at the given ratio between 0 and 1
     */
     ...
     * @param text the textual representation to parse into a FloatMass
    ...
    public static FloatMass of(final float value, final String unitString)
    {
        ...
        MassUnit unit = MassUnit.BASE.getUnitByAbbreviation(unitString);
        Throw.when(unit == null, IllegalArgumentException.class, "Error parsing FloatMass with unit %s", unitString);
        return new FloatMass(value, unit);
    }
     ...
     * @param v scalar
     * @return scalar as a division of FloatMass and FloatMass
     */
     ...
     * @param v scalar
     * @return scalar as a division of FloatMass and FloatFlowMass
     */
     ...
     * @param v scalar
     * @return scalar as a division of FloatMass and FloatDuration
     */
     ...
     * @param v scalar
     * @return scalar as a multiplication of FloatMass and FloatAcceleration
     */
     ...
     * @param v scalar
     * @return scalar as a multiplication of FloatMass and FloatFrequency
     */
     ...
     * @param v scalar
     * @return scalar as a division of FloatMass and FloatDensity
     */
     ...
     * @param v scalar
     * @return scalar as a division of FloatMass and FloatVolume
     */
     ...
     * @param v scalar
     * @return scalar as a multiplication of FloatMass and FloatSpeed
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatMass.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatMass
     */
    public static FloatMass multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type FloatMass",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatMass(scalar1.si * scalar2.si, MassUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatMass.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatMass
     */
    public static FloatMass divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type FloatMass",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatMass(scalar1.si / scalar2.si, MassUnit.SI);
    }
