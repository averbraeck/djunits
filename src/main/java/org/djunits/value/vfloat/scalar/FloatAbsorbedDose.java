...
public class FloatAbsorbedDose extends FloatScalarRel<AbsorbedDoseUnit, FloatAbsorbedDose>
{
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatAbsorbedDose.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatAbsorbedDose
     */
    public static FloatAbsorbedDose multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type FloatAbsorbedDose",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatAbsorbedDose(scalar1.si * scalar2.si, AbsorbedDoseUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatAbsorbedDose.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatAbsorbedDose
     */
    public static FloatAbsorbedDose divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                ...
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type FloatAbsorbedDose",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatAbsorbedDose(scalar1.si / scalar2.si, AbsorbedDoseUnit.SI);
    }
