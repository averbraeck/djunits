...
public class FloatAccelerationVector extends FloatVectorRel<AccelerationUnit, FloatAcceleration, FloatAccelerationVector>

{
    ...
    /**
     * Construct a FloatAccelerationVector from a list of Number objects or a list of FloatAcceleration objects. Note that the
     * displayUnit has a different meaning depending on whether the list contains Number objects (e.g., Float objects) or
     * FloatAcceleration objects. In case the list contains Number objects, the displayUnit indicates the unit in which the
     ...
     * unit when printing.
     * @param data the data for the vector as a List&lt;Float&gt; or List&lt;Acceleration&gt;
    ...
    /**
     * Construct a FloatAccelerationVector from a list of Number objects or a list of FloatAcceleration objects. When data
    ...
    /* CONSTRUCTORS WITH Map<Integer, Float> or Map<Integer, FloatAcceleration> */

    /**
     * Construct a FloatAccelerationVector from a (sparse) map of index values to Number objects or a (sparse) map of index
     * values to of FloatAcceleration objects. Using index values is particularly useful for sparse vectors. The size parameter
     * indicates the size of the vector, since the largest index does not have to be part of the map. Note that the displayUnit
     * has a different meaning depending on whether the map contains Number objects (e.g., Float objects) or FloatAcceleration
     ...
     * @param data the data for the vector as a Map&lt;Integer, Float&gt; or Map&lt;Integer, FloatAcceleration&gt;
            ...
            final AccelerationUnit displayUnit, final StorageType storageType)
    {
        this(data.size() == 0 ? FloatVectorData.instantiate(data, size, IdentityScale.SCALE, storageType)
                : data.values().iterator().next() instanceof FloatAcceleration
