...

{
    ...
    /**
     * Construct an MagneticFluxVector from a double[] object. The double values are expressed in the displayUnit, and will be printed
    ...
    /**
     * Construct an MagneticFluxVector from a double[] object. The double values are expressed in the displayUnit. Assume that the
    ...
    /**
     * Construct an MagneticFluxVector from a double[] object with SI-unit values. Assume that the StorageType is DENSE since we offer
    ...
    /**
     * Construct an MagneticFluxVector from an array of MagneticFlux objects. The MagneticFlux values are each expressed in their own unit, but will be
    ...
    /**
     * Construct an MagneticFluxVector from a list of Number objects or a list of MagneticFlux objects. Note that the displayUnit has a
     * different meaning depending on whether the list contains Number objects (e.g., Double objects) or MagneticFlux objects. In case
     * the list contains Number objects, the displayUnit indicates the unit in which the values in the list are expressed, as
     * well as the unit in which they will be printed. In case the list contains MagneticFlux objects, each MagneticFlux has its own unit, and
     ...
     * @param data the data for the vector as a List&lt;Double&gt; or List&lt;MagneticFlux&gt;
     ...
     * @param storageType the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public MagneticFluxVector(final List<? extends Number> data, final MagneticFluxUnit displayUnit, final StorageType storageType)
    {
    ...
    /**
     * Construct an MagneticFluxVector from a list of Number objects or a list of MagneticFlux objects. When data contains numbers such as
     * Double, assume that they are expressed using SI units. When the data consists of MagneticFlux objects, they each have their own
    ...
    /**
     * Construct an MagneticFluxVector from a (sparse) map of index values to Number objects or a (sparse) map of index values to of
     * MagneticFlux objects. Using index values is particularly useful for sparse vectors. The size parameter indicates the size of the
     * vector, since the largest index does not have to be part of the map. Note that the displayUnit has a different meaning
     * depending on whether the map contains Number objects (e.g., Double objects) or MagneticFlux objects. In case the map contains
     * Number objects, the displayUnit indicates the unit in which the values in the map are expressed, as well as the unit in
     * which they will be printed. In case the map contains MagneticFlux objects, each MagneticFlux has its own unit, and the displayUnit is
     ...
     * @param data the data for the vector as a Map&lt;Integer, Double&gt; or Map&lt;Integer, MagneticFlux&gt;
     ...
     * that they are expressed using SI units. When the data consists of MagneticFlux objects, they each have their own unit, but will
