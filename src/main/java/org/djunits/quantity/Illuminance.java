...
public class Illuminance extends Quantity.Relative<Illuminance, Illuminance.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Illuminance.Unit>
    {
        ...
        /** Gray. */
        public static final Illuminance.Unit GRAY = new Illuminance.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final Illuminance.Unit SI = GRAY;

        /** mGy. */
        public static final Illuminance.Unit MILLIGRAY =
                new Illuminance.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final Illuminance.Unit MICROGRAY =
                new Illuminance.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final Illuminance.Unit ERG_PER_GRAM =
                new Illuminance.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final Illuminance.Unit RAD = new Illuminance.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Illuminance.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
