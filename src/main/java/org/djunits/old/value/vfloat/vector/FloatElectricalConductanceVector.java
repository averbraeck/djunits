...
import org.djunits.old.value.vfloat.scalar.FloatElectricalConductance;
...
public class FloatElectricalConductanceVector
        extends FloatVectorRel<ElectricalConductanceUnit, FloatElectricalConductance, FloatElectricalConductanceVector>

{
    ...
    /**
     * Construct a FloatElectricalConductanceVector from a list of Number objects or a list of FloatElectricalConductance
     * objects. Note that the displayUnit has a different meaning depending on whether the list contains Number objects (e.g.,
     * Float objects) or FloatElectricalConductance objects. In case the list contains Number objects, the displayUnit indicates
     ...
     * @param data the data for the vector as a List&lt;Float&gt; or List&lt;ElectricalConductance&gt;
            ...
            final StorageType storageType)
    {
        this(data.size() == 0 ? FloatVectorData.instantiate(new float[] {}, IdentityScale.SCALE, storageType)
                : data.get(0) instanceof FloatElectricalConductance
    ...
    /* CONSTRUCTORS WITH Map<Integer, Float> or Map<Integer, FloatElectricalConductance> */

    /**
     * Construct a FloatElectricalConductanceVector from a (sparse) map of index values to Number objects or a (sparse) map of
     * index values to of FloatElectricalConductance objects. Using index values is particularly useful for sparse vectors. The
     ...
     * FloatElectricalConductance objects. In case the map contains Number objects, the displayUnit indicates the unit in which
     ...
     * @param data the data for the vector as a Map&lt;Integer, Float&gt; or Map&lt;Integer, FloatElectricalConductance&gt;
            ...
            final ElectricalConductanceUnit displayUnit, final StorageType storageType)
    {
        this(data.size() == 0 ? FloatVectorData.instantiate(data, size, IdentityScale.SCALE, storageType)
                : data.values().iterator().next() instanceof FloatElectricalConductance
