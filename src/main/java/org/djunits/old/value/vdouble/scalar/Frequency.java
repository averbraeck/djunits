...
public class Frequency extends DoubleScalarRel<FrequencyUnit, Frequency>
{
    ...
    /**
     * Construct Frequency scalar with a unit.
    ...
    /**
     * Construct Frequency scalar based on an SI value.
     ...
     * @return a Frequency at the given ratio between 0 and 1
     */
     ...
     * @param v scalar
     * @return scalar as a division of Frequency and Frequency
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type Frequency.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of Frequency
     */
    public static Frequency multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type Frequency",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new Frequency(scalar1.si * scalar2.si, FrequencyUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type Frequency.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of Frequency
     */
    public static Frequency divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .minus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(FrequencyUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type Frequency",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new Frequency(scalar1.si / scalar2.si, FrequencyUnit.SI);
    }
