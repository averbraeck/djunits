        ...
        extends Vector<Q, V, SI, H, VT>
{
     ...
     */
    protected Vector2(final double xSi, final double ySi, final UnitInterface<Q> displayUnit)
    {
        super(displayUnit);
        this.xSi = xSi;
        this.ySi = ySi;
     ...
     */
    protected abstract V instantiateSi(double xSiNew, double ySiNew, UnitInterface<Q> displayUnit);
    ...
    public V instantiateSi(final double[] siNew, final UnitInterface<Q> displayUnit)
    {
        Throw.when(siNew.length != 2, IllegalArgumentException.class, "Size of new data for Vector2 != 2, but %d",
                siNew.length);
        return instantiateSi(siNew[0], siNew[1], displayUnit);
    }
    ...
    {
        return instantiateSi(this.xSi * factor, this.ySi * factor, getDisplayUnit());
    }

    @Override
    public V add(final V other)
    {
        return instantiateSi(this.xSi + other.xSi(), this.ySi + other.ySi(), getDisplayUnit());
    }
    ...
    public V negate()
    {
        return instantiateSi(-this.xSi, -this.ySi, getDisplayUnit());
    }

    @Override
    public V abs()
    {
        return instantiateSi(Math.abs(this.xSi), Math.abs(this.ySi), getDisplayUnit());
    }

    @Override
    public Q normL1()
    {
        return getDisplayUnit().ofSi(Math.abs(this.xSi) + Math.abs(this.ySi), getDisplayUnit());
    }

    @Override
    public Q normL2()
    {
        return getDisplayUnit().ofSi(Math.sqrt(this.xSi * this.xSi + this.ySi * this.ySi), getDisplayUnit());
    }
    ...
    public Q mean()
    {
        return getDisplayUnit().ofSi((this.xSi + this.ySi) / 2.0, getDisplayUnit());
    }
    ...
    public Q sum()
    {
        return getDisplayUnit().ofSi(this.xSi + this.ySi, getDisplayUnit());
    }

    @Override
    public V add(final Q increment)
    {
        return instantiateSi(this.xSi + increment.si(), this.ySi + increment.si(), getDisplayUnit());
    }

    @Override
    public V subtract(final Q decrement)
    {
        return instantiateSi(this.xSi - decrement.si(), this.ySi - decrement.si(), getDisplayUnit());
    }
            ...
            implements Vector.Col<Vector2.Col<Q>, Q>
    {
         ...
         * @param displayUnit the display unit to use
         */
        public Col(final double xSi, final double ySi, final UnitInterface<Q> displayUnit)
        {
        ...
        @Override
        protected Vector2.Col<Q> instantiateSi(final double xSi, final double ySi, final UnitInterface<Q> displayUnit)
        {
         ...
         * @param <Q> the quantity type
         */
        public static <Q extends Quantity<Q>> Vector2.Col<Q> of(final double[] dataInUnit, final UnitInterface<Q> unit)
        {
         ...
         * @param <Q> the quantity type
         */
        public static <Q extends Quantity<Q>> Vector2.Col<Q> ofSi(final double[] dataSi, final UnitInterface<Q> displayUnit)
        {
         ...
         */
        public <TQ extends Quantity<TQ>> Vector2.Col<TQ> as(final UnitInterface<TQ> targetUnit) throws IllegalArgumentException
        {
            ...
            implements Vector.Row<Vector2.Row<Q>, Q>
    {
         ...
         * @param displayUnit the display unit to use
         */
        public Row(final double xSi, final double ySi, final UnitInterface<Q> displayUnit)
        {
            super(xSi, ySi, displayUnit);
        }
        ...
        @Override
        protected Vector2.Row<Q> instantiateSi(final double xSi, final double ySi, final UnitInterface<Q> displayUnit)
        {
         ...
         * @param <Q> the quantity type
         */
        public static <Q extends Quantity<Q>> Vector2.Row<Q> of(final double[] dataInUnit, final UnitInterface<Q> unit)
        {
            Throw.whenNull(dataInUnit, "dataInUnit");
            Throw.when(dataInUnit.length != 2, IllegalArgumentException.class, "Length of dataInUnit != 2 but %d",
                    dataInUnit.length);
         ...
         * @param <Q> the quantity type
         */
        public static <Q extends Quantity<Q>> Vector2.Row<Q> ofSi(final double[] dataSi, final UnitInterface<Q> displayUnit)
        {
            Throw.whenNull(dataSi, "dataSi");
            Throw.whenNull(displayUnit, "displayUnit");
            Throw.when(dataSi.length != 2, IllegalArgumentException.class, "Length of dataSi != 2 but %d", dataSi.length);
         ...
         * @param <TQ> target quantity type
         */
        public <TQ extends Quantity<TQ>> Vector2.Row<TQ> as(final UnitInterface<TQ> targetUnit) throws IllegalArgumentException
        {
            Throw.when(!getDisplayUnit().siUnit().equals(targetUnit.siUnit()), IllegalArgumentException.class,
                    "Quantity.as(%s) called, but units do not match: %s <> %s", targetUnit,
                    getDisplayUnit().siUnit().getDisplayAbbreviation(), targetUnit.siUnit().getDisplayAbbreviation());
