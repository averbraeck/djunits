...
public class ElectricalResistance extends Quantity.Relative<ElectricalResistance, ElectricalResistance.Unit>
{
    ...
    public static class Unit extends AbstractUnit<ElectricalResistance.Unit>
    {
        ...
        /** Gray. */
        public static final ElectricalResistance.Unit GRAY = new ElectricalResistance.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);
        ...
        /** &#181;Gy. */
        public static final ElectricalResistance.Unit MICROGRAY =
                new ElectricalResistance.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new ElectricalResistance.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
