...
public class AngularVelocity extends Quantity<AngularVelocity>
{
     ...
     */
    public static AngularVelocity of(final double valueInUnit, final String unitString)
    {
        return Quantity.of(valueInUnit, unitString, ZERO);
    }

    @Override
    public AngularVelocity.Unit getDisplayUnit()
    {
        return (AngularVelocity.Unit) super.getDisplayUnit();
    }
