...
public class Momentum extends Quantity.Relative<Momentum, Momentum.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Momentum.Unit>
    {
        ...
        /** Gray. */
        public static final Momentum.Unit GRAY = new Momentum.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final Momentum.Unit SI = GRAY;

        /** mGy. */
        public static final Momentum.Unit MILLIGRAY =
                new Momentum.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final Momentum.Unit MICROGRAY =
                new Momentum.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final Momentum.Unit ERG_PER_GRAM =
                new Momentum.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final Momentum.Unit RAD = new Momentum.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Momentum.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
