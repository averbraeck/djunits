...
public class FloatElectricalPotential extends FloatScalarRel<ElectricalPotentialUnit, FloatElectricalPotential>
{
    ...
    /**
     * Construct FloatElectricalPotential scalar with a unit.
    ...
    /**
     * Construct FloatElectricalPotential scalar with a unit using a double value.
    ...
    /**
     * Construct FloatElectricalPotential scalar based on an SI value.
     ...
     * @return a FloatElectricalPotential at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatElectricalPotential.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatElectricalPotential
     */
    public static FloatElectricalPotential multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(ElectricalPotentialUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class,
                "Multiplying %s by %s does not result in instance of type FloatElectricalPotential", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new FloatElectricalPotential(scalar1.si * scalar2.si, ElectricalPotentialUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatElectricalPotential.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatElectricalPotential
     */
    public static FloatElectricalPotential divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(ElectricalPotentialUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class,
                "Dividing %s by %s does not result in an instance of type FloatElectricalPotential", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new FloatElectricalPotential(scalar1.si / scalar2.si, ElectricalPotentialUnit.SI);
    }
