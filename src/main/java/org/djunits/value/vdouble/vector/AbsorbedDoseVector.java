...
public class AbsorbedDoseVector extends DoubleVectorRel<AbsorbedDoseUnit, AbsorbedDose, AbsorbedDoseVector>

{
    ...
    /**
     * Construct an AbsorbedDoseVector from a double[] object. The double values are expressed in the displayUnit, and will be printed
    ...
    /**
     * Construct an AbsorbedDoseVector from a double[] object. The double values are expressed in the displayUnit. Assume that the
    ...
    /**
     * Construct an AbsorbedDoseVector from a double[] object with SI-unit values. Assume that the StorageType is DENSE since we offer
    ...
    /**
     * Construct an AbsorbedDoseVector from an array of AbsorbedDose objects. The AbsorbedDose values are each expressed in their own unit, but will be
    ...
    /**
     * Construct an AbsorbedDoseVector from a list of Number objects or a list of AbsorbedDose objects. Note that the displayUnit has a
     * different meaning depending on whether the list contains Number objects (e.g., Double objects) or AbsorbedDose objects. In case
     * the list contains Number objects, the displayUnit indicates the unit in which the values in the list are expressed, as
     * well as the unit in which they will be printed. In case the list contains AbsorbedDose objects, each AbsorbedDose has its own unit, and
     ...
     * @param data the data for the vector as a List&lt;Double&gt; or List&lt;AbsorbedDose&gt;
     ...
     * @param storageType the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public AbsorbedDoseVector(final List<? extends Number> data, final AbsorbedDoseUnit displayUnit, final StorageType storageType)
    {
    ...
    /**
     * Construct an AbsorbedDoseVector from a list of Number objects or a list of AbsorbedDose objects. When data contains numbers such as
     * Double, assume that they are expressed using SI units. When the data consists of AbsorbedDose objects, they each have their own
    ...
    /* CONSTRUCTORS WITH Map<Integer, Double> or Map<Integer, AbsorbedDose> */

    /**
     * Construct an AbsorbedDoseVector from a (sparse) map of index values to Number objects or a (sparse) map of index values to of
     * AbsorbedDose objects. Using index values is particularly useful for sparse vectors. The size parameter indicates the size of the
     * vector, since the largest index does not have to be part of the map. Note that the displayUnit has a different meaning
     * depending on whether the map contains Number objects (e.g., Double objects) or AbsorbedDose objects. In case the map contains
     * Number objects, the displayUnit indicates the unit in which the values in the map are expressed, as well as the unit in
     * which they will be printed. In case the map contains AbsorbedDose objects, each AbsorbedDose has its own unit, and the displayUnit is
     ...
     * @param data the data for the vector as a Map&lt;Integer, Double&gt; or Map&lt;Integer, AbsorbedDose&gt;
     * @param size the size off the vector, i.e., the highest index
     * @param displayUnit the display unit of the vector data, and the unit of the data points when the data is
     *            expressed as List&lt;Double&gt; or List&lt;Number&gt; in general
     * @param storageType the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public AbsorbedDoseVector(final Map<Integer, ? extends Number> data, final int size, final AbsorbedDoseUnit displayUnit,
            final StorageType storageType)
    {
        this(data.size() == 0 ? DoubleVectorData.instantiate(data, size, IdentityScale.SCALE, storageType)
                : data.values().iterator().next() instanceof AbsorbedDose
     ...
     * that they are expressed using SI units. When the data consists of AbsorbedDose objects, they each have their own unit, but will
     ...
     * @param storageType the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public AbsorbedDoseVector(final Map<Integer, ? extends Number> data, final int size, final StorageType storageType)
    {
     ...
     * @param size the size off the vector, i.e., the highest index
     */
    public AbsorbedDoseVector(final Map<Integer, ? extends Number> data, final int size)
    {
