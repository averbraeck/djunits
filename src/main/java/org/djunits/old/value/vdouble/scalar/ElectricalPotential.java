...
public class ElectricalPotential extends DoubleScalarRel<ElectricalPotentialUnit, ElectricalPotential>
{
    ...
    /**
     * Construct ElectricalPotential scalar with a unit.
    ...
    /**
     * Construct ElectricalPotential scalar based on an SI value.
     ...
     * @return a ElectricalPotential at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type ElectricalPotential.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of ElectricalPotential
     */
    public static ElectricalPotential multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type ElectricalPotential",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new ElectricalPotential(scalar1.si * scalar2.si, ElectricalPotentialUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type ElectricalPotential.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of ElectricalPotential
     */
    public static ElectricalPotential divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(ElectricalPotentialUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type ElectricalPotential",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new ElectricalPotential(scalar1.si / scalar2.si, ElectricalPotentialUnit.SI);
    }
