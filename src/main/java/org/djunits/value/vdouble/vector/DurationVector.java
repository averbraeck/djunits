...
public class DurationVector extends DoubleVectorRelWithAbs<TimeUnit, Time, TimeVector, 
        DurationUnit, Duration, DurationVector>
{
    ...
    /**
     * Construct an DurationVector from a double[] object. The double values are expressed in the displayUnit, and will be printed
    ...
    /**
     * Construct an DurationVector from a double[] object with SI-unit values. Assume that the StorageType is DENSE since we offer
    ...
    /**
     * Construct an DurationVector from an array of Duration objects. The Duration values are each expressed in their own unit, but will be
     ...
     * different meaning depending on whether the list contains Number objects (e.g., Double objects) or Duration objects. In case
     * the list contains Number objects, the displayUnit indicates the unit in which the values in the list are expressed, as
     * well as the unit in which they will be printed. In case the list contains Duration objects, each Duration has its own unit, and
     ...
     * @param data the data for the vector as a List&lt;Double&gt; or List&lt;Duration&gt;
    ...
    /**
     * Construct an DurationVector from a list of Number objects or a list of Duration objects. When data contains numbers such as
     * Double, assume that they are expressed using SI units. When the data consists of Duration objects, they each have their own
     ...
     * Duration objects. Using index values is particularly useful for sparse vectors. The size parameter indicates the size of the
     * vector, since the largest index does not have to be part of the map. Note that the displayUnit has a different meaning
     * depending on whether the map contains Number objects (e.g., Double objects) or Duration objects. In case the map contains
     * Number objects, the displayUnit indicates the unit in which the values in the map are expressed, as well as the unit in
     * which they will be printed. In case the map contains Duration objects, each Duration has its own unit, and the displayUnit is
     ...
     * @param data the data for the vector as a Map&lt;Integer, Double&gt; or Map&lt;Integer, Duration&gt;
     ...
     * that they are expressed using SI units. When the data consists of Duration objects, they each have their own unit, but will
