package org.djunits.old.value.vfloat.matrix.data;
...
public abstract class FloatMatrixData extends Storage<FloatMatrixData> implements Serializable
{
     ...
     * @param <S> the corresponding scalar type
     */
    protected static <U extends Unit<U>, S extends FloatScalar<U, S>> S[][] checkRectangularAndNonNull(final S[][] values)
            throws ValueRuntimeException
    {
