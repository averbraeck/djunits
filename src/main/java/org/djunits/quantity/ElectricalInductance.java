...
public class ElectricalInductance extends Quantity.Relative<ElectricalInductance, ElectricalInductance.Unit>
{
    ...
    public static final ElectricalInductance ZERO = ElectricalInductance.ofSi(0.0);

    /** Constant with value one. */
    public static final ElectricalInductance ONE = ElectricalInductance.ofSi(1.0);

    /** Constant with value NaN. */
    @SuppressWarnings("checkstyle:constantname")
    public static final ElectricalInductance NaN = ElectricalInductance.ofSi(Double.NaN);

    /** Constant with value POSITIVE_INFINITY. */
    public static final ElectricalInductance POSITIVE_INFINITY = ElectricalInductance.ofSi(Double.POSITIVE_INFINITY);

    /** Constant with value NEGATIVE_INFINITY. */
    public static final ElectricalInductance NEGATIVE_INFINITY = ElectricalInductance.ofSi(Double.NEGATIVE_INFINITY);

    /** Constant with value MAX_VALUE. */
    public static final ElectricalInductance POS_MAXVALUE = ElectricalInductance.ofSi(Double.MAX_VALUE);
     ...
     */
    public ElectricalInductance(final double value, final ElectricalInductance.Unit unit)
    {
        super(value, unit);
    }
     ...
     */
    public ElectricalInductance(final double value, final String abbreviation)
    {
        this(value, Units.resolve(ElectricalInductance.Unit.class, abbreviation));
    }
    ...
    {
        super(value.si(), ElectricalInductance.Unit.SI);
    ...
    {
        return new ElectricalInductance(si, ElectricalInductance.Unit.SI);
    }

    @Override
    public ElectricalInductance instantiate(final double si)
    {
        return ofSi(si);
    }
    ...
    {
        return ElectricalInductance.Unit.SI_UNIT;
    }
    ...
    public static class Unit extends AbstractUnit<ElectricalInductance.Unit>
    {
        ...
        /** Gray. */
        public static final ElectricalInductance.Unit GRAY = new ElectricalInductance.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);
        ...
        /** &#181;Gy. */
        public static final ElectricalInductance.Unit MICROGRAY =
                new ElectricalInductance.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new ElectricalInductance.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
