...
public class VolumetricObjectDensity extends Quantity<VolumetricObjectDensity>
{
     ...
     */
    public VolumetricObjectDensity(final double valueInUnit, final String abbreviation)
    {
        this(valueInUnit, Units.resolve(VolumetricObjectDensity.Unit.class, abbreviation));
    }
