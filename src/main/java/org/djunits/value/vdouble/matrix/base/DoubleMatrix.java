        ...
        M extends DoubleMatrix<U, S, V, M>> extends Matrix<U, S, V, DoubleVectorData, M, DoubleMatrixData>
{
    ...
    private static final Map<Unit<?>, Constructor<? extends DoubleMatrix<?, ?, ?, ?>>> CACHE_DATA = new HashMap<>();
    ...
    public static <U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
            M extends DoubleMatrix<U, S, V, M>> M instantiate(final double[][] valuesInUnit, final U unit,
     ...
     */
    public static <U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
            M extends DoubleMatrix<U, S, V, M>> M instantiateSI(final double[][] valuesSI, final U displayUnit,
                    final StorageType storageType)
    {
     ...
     */
    public static <U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
            M extends DoubleMatrix<U, S, V, M>> M instantiate(final DoubleMatrixData values, final U unit)
    {
     ...
     */
    public static <U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
            M extends DoubleMatrix<U, S, V, M>> M instantiate(final S[][] values, final U displayUnit,
                    final StorageType storageType)
    {
     ...
     */
    public static <U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
            M extends DoubleMatrix<U, S, V, M>> M instantiate(final Collection<DoubleSparseValue<U, S>> values,
    ...
    @SuppressWarnings("unchecked")
    public static <U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
            M extends DoubleMatrix<U, S, V, M>> M instantiateAnonymous(final DoubleMatrixData values,
                    final Unit<?> unit)
    {
        ...
        try
        {
            Constructor<? extends DoubleMatrix<?, ?, ?, ?>> matrixConstructor = CACHE_DATA.get(unit);
        ...
        {
            throw new UnitRuntimeException("Cannot instantiate DoubleMatrix of unit " + unit.toString() + ". Reason: "
