...
public class ForceMatrix extends DoubleMatrixRel<ForceUnit, Force, ForceVector, ForceMatrix>

{
     ...
     * @param displayUnit ForceUnit; the display unit of the matrix data
     */
    public ForceMatrix(final DoubleMatrixData data, final ForceUnit displayUnit)
    {
    ...
    /**
     * Construct a ForceMatrix from a double[][] object. The double values are expressed in the displayUnit, and will be printed
     * using the displayUnit.
     * @param data double[][]; the data for the matrix, expressed in the displayUnit
     * @param displayUnit ForceUnit; the unit of the values in the data array, and display unit when printing
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ForceMatrix(final double[][] data, final ForceUnit displayUnit, final StorageType storageType)
    {
        this(DoubleMatrixData.instantiate(data, displayUnit.getScale(), storageType), displayUnit);
    }

    /**
     * Construct a ForceMatrix from a double[][] object. The double values are expressed in the displayUnit. Assume that the
     * StorageType is DENSE since we offer the data as an array of an array.
     * @param data double[][]; the data for the matrix
     * @param displayUnit ForceUnit; the unit of the values in the data array, and display unit when printing
     */
    public ForceMatrix(final double[][] data, final ForceUnit displayUnit)
    {
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ForceMatrix(final double[][] data, final StorageType storageType)
    {
        this(data, ForceUnit.SI, storageType);
    }

    /**
     * Construct a ForceMatrix from a double[][] object with SI-unit values. Assume that the StorageType is DENSE since we offer
     * the data as an array of an array.
     * @param data double[][]; the data for the matrix, in SI units
     */
    public ForceMatrix(final double[][] data)
    {
    ...
    /**
     * Construct a ForceMatrix from an array of an array of Force objects. The Force values are each expressed in their own
     * unit, but will be internally stored as SI values, all expressed in the displayUnit when printing.
     * @param data Force[][]; the data for the matrix
     * @param displayUnit ForceUnit; the display unit of the values when printing
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ForceMatrix(final Force[][] data, final ForceUnit displayUnit, final StorageType storageType)
    {
     ...
     * @param displayUnit ForceUnit; the display unit of the values when printing
     */
    public ForceMatrix(final Force[][] data, final ForceUnit displayUnit)
    {
        this(data, displayUnit, StorageType.DENSE);
    }
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ForceMatrix(final Force[][] data, final StorageType storageType)
    {
        this(data, ForceUnit.SI, storageType);
    }
     ...
     * @param data Force[][]; the data for the matrix
     */
    public ForceMatrix(final Force[][] data)
    {
        this(data, StorageType.DENSE);
    }
    ...
    /**
     * Construct a ForceMatrix from a (sparse) collection of DoubleSparseValue objects. The displayUnit indicates the unit in
     ...
     * @param displayUnit ForceUnit; the display unit of the matrix data, and the unit of the data points
     * @param rows int; the number of rows of the matrix
     * @param cols int; the number of columns of the matrix
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ForceMatrix(final Collection<DoubleSparseValue<ForceUnit, Force>> data, final ForceUnit displayUnit, final int rows,
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ForceMatrix(final Collection<DoubleSparseValue<ForceUnit, Force>> data, final int rows, final int cols,
