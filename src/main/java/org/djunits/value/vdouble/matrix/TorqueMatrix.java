...

{
     ...
     */
    public TorqueMatrix(final DoubleMatrixData data, final TorqueUnit displayUnit)
    {
    ...
    /**
     * Construct a TorqueMatrix from a double[][] object. The double values are expressed in the displayUnit, and will be
     ...
     */
    public TorqueMatrix(final double[][] data, final TorqueUnit displayUnit, final StorageType storageType)
    {
        this(DoubleMatrixData.instantiate(data, displayUnit.getScale(), storageType), displayUnit);
    }

    /**
     * Construct a TorqueMatrix from a double[][] object. The double values are expressed in the displayUnit. Assume that the
     * StorageType is DENSE since we offer the data as an array of an array.
     * @param data double[][]; the data for the matrix
     * @param displayUnit TorqueUnit; the unit of the values in the data array, and display unit when printing
     */
    public TorqueMatrix(final double[][] data, final TorqueUnit displayUnit)
    {
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public TorqueMatrix(final double[][] data, final StorageType storageType)
    {
        this(data, TorqueUnit.SI, storageType);
    }

    /**
     * Construct a TorqueMatrix from a double[][] object with SI-unit values. Assume that the StorageType is DENSE since we
     * offer the data as an array of an array.
     * @param data double[][]; the data for the matrix, in SI units
     */
    public TorqueMatrix(final double[][] data)
    {
    ...
    /**
     * Construct a TorqueMatrix from an array of an array of Torque objects. The Torque values are each expressed in their own
     * unit, but will be internally stored as SI values, all expressed in the displayUnit when printing.
     * @param data Torque[][]; the data for the matrix
     * @param displayUnit TorqueUnit; the display unit of the values when printing
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public TorqueMatrix(final Torque[][] data, final TorqueUnit displayUnit, final StorageType storageType)
    {
     ...
     * @param displayUnit TorqueUnit; the display unit of the values when printing
     */
    public TorqueMatrix(final Torque[][] data, final TorqueUnit displayUnit)
    {
        this(data, displayUnit, StorageType.DENSE);
    }
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public TorqueMatrix(final Torque[][] data, final StorageType storageType)
    {
        this(data, TorqueUnit.SI, storageType);
    }
     ...
     * @param data Torque[][]; the data for the matrix
     */
    public TorqueMatrix(final Torque[][] data)
    {
        this(data, StorageType.DENSE);
    }
    ...
    /**
     * Construct a TorqueMatrix from a (sparse) collection of DoubleSparseValue objects. The displayUnit indicates the unit in
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public TorqueMatrix(final Collection<DoubleSparseValue<TorqueUnit, Torque>> data, final TorqueUnit displayUnit,
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public TorqueMatrix(final Collection<DoubleSparseValue<TorqueUnit, Torque>> data, final int rows, final int cols,
