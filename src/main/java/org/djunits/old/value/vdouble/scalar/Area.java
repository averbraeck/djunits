...
public class Area extends DoubleScalarRel<AreaUnit, Area>
{
    ...
    /**
     * Construct Area scalar with a unit.
    ...
    /**
     * Construct Area scalar based on an SI value.
     ...
     * @return a Area at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type Area.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of Area
     */
    public static Area multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type Area",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new Area(scalar1.si * scalar2.si, AreaUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type Area.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of Area
     */
    public static Area divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type Area",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new Area(scalar1.si / scalar2.si, AreaUnit.SI);
    }
