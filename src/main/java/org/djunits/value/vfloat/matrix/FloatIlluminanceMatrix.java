...

{
     ...
     * @param displayUnit IlluminanceUnit; the display unit of the matrix data
     */
     ...
     * printing.
     * @param data FloatIlluminance[][]; the data for the matrix
     ...
     * @param displayUnit IlluminanceUnit; the display unit of the matrix data, and the unit of the data points
