...
public class PressureUnitTest extends AbstractLinearUnitTest<Pressure.Unit>
{
    ...
    {
        assertEquals("kg/ms2", Pressure.Unit.SI_UNIT.format(true, false));
    ...
    final void testStandardMethods()
    {
        ...
        Pressure.Unit nonlinearUnit = new Pressure.Unit("xx", "xx", "xx", new GradeScale(0.1), UnitSystem.OTHER, null);
