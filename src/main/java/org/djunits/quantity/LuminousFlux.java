...
public class LuminousFlux extends Quantity.Relative<LuminousFlux, LuminousFlux.Unit>
{
    ...
    public static class Unit extends AbstractUnit<LuminousFlux.Unit>
    {
        ...
        /** Gray. */
        public static final LuminousFlux.Unit GRAY = new LuminousFlux.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final LuminousFlux.Unit SI = GRAY;

        /** mGy. */
        public static final LuminousFlux.Unit MILLIGRAY =
                new LuminousFlux.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final LuminousFlux.Unit MICROGRAY =
                new LuminousFlux.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final LuminousFlux.Unit ERG_PER_GRAM =
                new LuminousFlux.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final LuminousFlux.Unit RAD = new LuminousFlux.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new LuminousFlux.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
