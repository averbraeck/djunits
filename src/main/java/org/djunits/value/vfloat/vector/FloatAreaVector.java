...

{
    ...
    /**
     * Construct a FloatAreaVector from a float[] object. The Float values are expressed in the displayUnit, and will be
     ...
     * @param data FloatArea[]; the data for the vector
    ...
    /**
     * Construct a FloatAreaVector from a list of Number objects or a list of FloatArea objects. Note that the displayUnit has
     * a different meaning depending on whether the list contains Number objects (e.g., Float objects) or FloatArea objects. In
     ...
     * @param data List&lt;Float&gt; or List&lt;Area&gt;; the data for the vector
     * @param displayUnit AreaUnit; the display unit of the vector data, and the unit of the data points when the data is
    ...
    /**
     * Construct a FloatAreaVector from a list of Number objects or a list of FloatArea objects. When data contains numbers
     * such as Float, assume that they are expressed using SI units. When the data consists of FloatArea objects, they each have
    ...
    /* CONSTRUCTORS WITH SortedMap<Integer, Float> or SortedMap<Integer, FloatArea> */

    /**
     * Construct a FloatAreaVector from a (sparse) map of index values to Number objects or a (sparse) map of index values to
     * of FloatArea objects. Using index values is particularly useful for sparse vectors. The size parameter indicates the size
     ...
     * @param data SortedMap&lt;Integer, Float&gt; or SortedMap&lt;Integer, FloatArea&gt;; the data for the vector
     * @param size int; the size off the vector, i.e., the highest index
     * @param displayUnit AreaUnit; the display unit of the vector data, and the unit of the data points when the data is
     *            expressed as List&lt;Float&gt; or List&lt;Number&gt; in general
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public FloatAreaVector(final SortedMap<Integer, ? extends Number> data, final int size, final AreaUnit displayUnit,
            final StorageType storageType)
    {
        this(data.size() == 0 ? FloatVectorData.instantiate(data, size, IdentityScale.SCALE, storageType)
                : data.get(data.firstKey()) instanceof FloatArea
     ...
     * assume that they are expressed using SI units. When the data consists of FloatArea objects, they each have their own
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Vector
     */
    public FloatAreaVector(final SortedMap<Integer, ? extends Number> data, final int size, final StorageType storageType)
    {
     ...
     * @param size int; the size off the vector, i.e., the highest index
     */
    public FloatAreaVector(final SortedMap<Integer, ? extends Number> data, final int size)
    {
