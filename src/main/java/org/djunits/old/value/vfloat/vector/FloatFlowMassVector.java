...
import org.djunits.old.value.vfloat.scalar.FloatFlowMass;
...

{
    ...
    /**
     * Construct a FloatFlowMassVector from a list of Number objects or a list of FloatFlowMass objects. Note that the
     * displayUnit has a different meaning depending on whether the list contains Number objects (e.g., Float objects) or
     * FloatFlowMass objects. In case the list contains Number objects, the displayUnit indicates the unit in which the values
     ...
     * @param data the data for the vector as a List&lt;Float&gt; or List&lt;FlowMass&gt;
    ...
    /**
     * Construct a FloatFlowMassVector from a list of Number objects or a list of FloatFlowMass objects. When data contains
    ...
    /* CONSTRUCTORS WITH Map<Integer, Float> or Map<Integer, FloatFlowMass> */

    /**
     * Construct a FloatFlowMassVector from a (sparse) map of index values to Number objects or a (sparse) map of index values
     * to of FloatFlowMass objects. Using index values is particularly useful for sparse vectors. The size parameter indicates
     * the size of the vector, since the largest index does not have to be part of the map. Note that the displayUnit has a
     * different meaning depending on whether the map contains Number objects (e.g., Float objects) or FloatFlowMass objects. In
     ...
     * @param data the data for the vector as a Map&lt;Integer, Float&gt; or Map&lt;Integer, FloatFlowMass&gt;
            ...
            final StorageType storageType)
    {
        this(data.size() == 0 ? FloatVectorData.instantiate(data, size, IdentityScale.SCALE, storageType)
                : data.values().iterator().next() instanceof FloatFlowMass
    ...
    {
        FloatFlowMass result = FloatFlowMass.ofSI(valueSI);
