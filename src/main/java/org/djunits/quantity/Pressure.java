...
public class Pressure extends Quantity.Relative<Pressure, Pressure.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Pressure.Unit>
    {
        ...
        /** mGy. */
        public static final Pressure.Unit MILLIGRAY = new Pressure.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);
        ...
        /** erg/g. */
        public static final Pressure.Unit ERG_PER_GRAM = new Pressure.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);
