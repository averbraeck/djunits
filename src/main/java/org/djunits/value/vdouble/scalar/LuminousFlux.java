...
public class LuminousFlux extends DoubleScalarRel<LuminousFluxUnit, LuminousFlux>
{
    ...
    /**
     * Multiply two scalars that result in a scalar of type LuminousFlux.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of LuminousFlux
     */
    public static LuminousFlux multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type LuminousFlux",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new LuminousFlux(scalar1.si * scalar2.si, LuminousFluxUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type LuminousFlux.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of LuminousFlux
     */
    public static LuminousFlux divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                ...
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type LuminousFlux",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new LuminousFlux(scalar1.si / scalar2.si, LuminousFluxUnit.SI);
    }
