...
public class MagneticFlux extends Quantity<MagneticFlux>
{
     ...
     */
    public static MagneticFlux of(final double valueInUnit, final String unitString)
    {
    ...
    public static class Unit extends AbstractUnit<MagneticFlux>
    {
        ...
        @Override
        public MagneticFlux.Unit deriveUnit(final String abbreviation, final String name, final double scaleFactor,
