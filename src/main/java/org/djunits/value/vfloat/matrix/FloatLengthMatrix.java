        ...
        FloatPositionMatrix, LengthUnit, FloatLength, FloatLengthVector, FloatLengthMatrix>
{
     ...
     * @param displayUnit LengthUnit; the display unit of the matrix data
     */
     ...
     * @param data FloatLength[][]; the data for the matrix
     ...
     * @param displayUnit LengthUnit; the display unit of the matrix data, and the unit of the data points
