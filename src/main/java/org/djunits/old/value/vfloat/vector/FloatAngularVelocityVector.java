...
import org.djunits.old.value.vfloat.scalar.FloatAngularVelocity;
...

{
     ...
     * unit when printing.
     * @param data the data for the vector as a List&lt;Float&gt; or List&lt;AngularVelocity&gt;
     ...
     * The values but will always be internally stored as SI values or base values, and expressed using the display unit or base
     * unit when printing.
     * @param data the data for the vector as a Map&lt;Integer, Float&gt; or Map&lt;Integer, FloatAngularVelocity&gt;
