...
public class FlowVolume extends Quantity<FlowVolume>
{
     ...
     */
    public FlowVolume(final double valueInUnit, final String abbreviation)
    {
        this(valueInUnit, Units.resolve(FlowVolume.Unit.class, abbreviation));
    }
     ...
     */
    public static FlowVolume of(final double valueInUnit, final String unitString)
    {
        return Quantity.of(valueInUnit, unitString, ZERO);
    }

    @Override
    public FlowVolume.Unit getDisplayUnit()
    {
        return (FlowVolume.Unit) super.getDisplayUnit();
    }
