...
public class DirectionVector extends DoubleVectorAbs<DirectionUnit, Direction, DirectionVector, 
        AngleUnit, Angle, AngleVector>
{
    ...
    /**
     * Construct an DirectionVector from a double[] object. The double values are expressed in the displayUnit, and will be printed
    ...
    /**
     * Construct an DirectionVector from a double[] object with SI-unit values. Assume that the StorageType is DENSE since we offer
    ...
    /**
     * Construct an DirectionVector from an array of Direction objects. The Direction values are each expressed in their own unit, but will be
    ...
    /**
     * Construct an DirectionVector from a list of Number objects or a list of Direction objects. Note that the displayUnit has a
     * different meaning depending on whether the list contains Number objects (e.g., Double objects) or Direction objects. In case
     * the list contains Number objects, the displayUnit indicates the unit in which the values in the list are expressed, as
     * well as the unit in which they will be printed. In case the list contains Direction objects, each Direction has its own unit, and
     ...
     * @param data the data for the vector as a List&lt;Double&gt; or List&lt;Direction&gt;
    ...
    /**
     * Construct an DirectionVector from a list of Number objects or a list of Direction objects. When data contains numbers such as
     * Double, assume that they are expressed using SI units. When the data consists of Direction objects, they each have their own
    ...
    /**
     * Construct an DirectionVector from a (sparse) map of index values to Number objects or a (sparse) map of index values to of
     * Direction objects. Using index values is particularly useful for sparse vectors. The size parameter indicates the size of the
     * vector, since the largest index does not have to be part of the map. Note that the displayUnit has a different meaning
     * depending on whether the map contains Number objects (e.g., Double objects) or Direction objects. In case the map contains
     * Number objects, the displayUnit indicates the unit in which the values in the map are expressed, as well as the unit in
     * which they will be printed. In case the map contains Direction objects, each Direction has its own unit, and the displayUnit is
     ...
     * @param data the data for the vector as a Map&lt;Integer, Double&gt; or Map&lt;Integer, Direction&gt;
     ...
     * that they are expressed using SI units. When the data consists of Direction objects, they each have their own unit, but will
