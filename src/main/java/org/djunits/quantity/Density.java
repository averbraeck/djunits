...
public class Density extends Quantity<Density>
{
    ...
    /**
     * Instantiate a Density quantity with an SI or base value and a display unit.
     ...
     */
    public Density(final double value, final Density.Unit displayUnit, final boolean useSi)
    {
        super(value, displayUnit, useSi);
    }

    /**
     * Instantiate a Density quantity expressed in the given unit.
     ...
     */
    public Density(final double valueInUnit, final Density.Unit unit)
    {
    ...
    {
        return new Density(si, Density.Unit.SI, true);
    }
     ...
     * @param displayUnit the display unit to use
     * @return the Density instance based on an SI value with the given display unit
     */
    public static Density ofSi(final double siValue, final Density.Unit displayUnit)
    {
        return new Density(siValue, displayUnit, true);
    }

    @Override
    public Density instantiateSi(final double siValue, final UnitInterface<Density> displayUnit)
    {
        return new Density(siValue, (Density.Unit) displayUnit, true);
    }
    ...
    /**
     * Returns a Density based on a value expressed in the unit.
     * @param valueInUnit the value, expressed in the given unit
     * @param unit the unit of the value, also acts as the display unit
     * @return ab Density representation of the value in its unit
     */
    public static Density of(final double valueInUnit, final Density.Unit unit)
    {
        return new Density(valueInUnit, unit);
    }
     ...
     */
    public static Density of(final double valueInUnit, final String unitString)
    {
        return Quantity.of(valueInUnit, unitString, ZERO);
    }

    @Override
    public Density.Unit getDisplayUnit()
    {
        return (Density.Unit) super.getDisplayUnit();
    }
     ...
     */
    @SuppressWarnings("checkstyle:constantname")
    public static class Unit extends AbstractUnit<Density>
    {
        ...
        @Override
        public Density ofSi(final double si, final UnitInterface<Density> displayUnit)
        {
            return new Density(si, (Unit) displayUnit, true);
        }

        @Override
        public Density.Unit deriveUnit(final String textualAbbreviation, final String displayAbbreviation, final String name,
                final double scaleFactor, final UnitSystem unitSystem, final SIPrefix siPrefix)
        {
            if (getScale() instanceof LinearScale ls)
            {
                return new Density.Unit(textualAbbreviation, displayAbbreviation, name,
        ...
        @Override
        public Density.Unit deriveUnit(final String abbreviation, final String name, final double scaleFactor,
