...
public class VolumeMatrix extends DoubleMatrixRel<VolumeUnit, Volume, VolumeVector, VolumeMatrix>

{
     ...
     * @param displayUnit VolumeUnit; the display unit of the matrix data
     */
    public VolumeMatrix(final DoubleMatrixData data, final VolumeUnit displayUnit)
    {
    ...
    /**
     * Construct a VolumeMatrix from a double[][] object. The double values are expressed in the displayUnit, and will be
     ...
     */
    public VolumeMatrix(final double[][] data, final VolumeUnit displayUnit, final StorageType storageType)
    {
        this(DoubleMatrixData.instantiate(data, displayUnit.getScale(), storageType), displayUnit);
    }

    /**
     * Construct a VolumeMatrix from a double[][] object. The double values are expressed in the displayUnit. Assume that the
     * StorageType is DENSE since we offer the data as an array of an array.
     * @param data double[][]; the data for the matrix
     * @param displayUnit VolumeUnit; the unit of the values in the data array, and display unit when printing
     */
    public VolumeMatrix(final double[][] data, final VolumeUnit displayUnit)
    {
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public VolumeMatrix(final double[][] data, final StorageType storageType)
    {
        this(data, VolumeUnit.SI, storageType);
    }

    /**
     * Construct a VolumeMatrix from a double[][] object with SI-unit values. Assume that the StorageType is DENSE since we
     * offer the data as an array of an array.
     * @param data double[][]; the data for the matrix, in SI units
     */
    public VolumeMatrix(final double[][] data)
    {
    ...
    /**
     * Construct a VolumeMatrix from an array of an array of Volume objects. The Volume values are each expressed in their own
     * unit, but will be internally stored as SI values, all expressed in the displayUnit when printing.
     * @param data Volume[][]; the data for the matrix
     * @param displayUnit VolumeUnit; the display unit of the values when printing
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public VolumeMatrix(final Volume[][] data, final VolumeUnit displayUnit, final StorageType storageType)
    {
     ...
     * @param displayUnit VolumeUnit; the display unit of the values when printing
     */
    public VolumeMatrix(final Volume[][] data, final VolumeUnit displayUnit)
    {
        this(data, displayUnit, StorageType.DENSE);
    }
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public VolumeMatrix(final Volume[][] data, final StorageType storageType)
    {
        this(data, VolumeUnit.SI, storageType);
    }
     ...
     * @param data Volume[][]; the data for the matrix
     */
    public VolumeMatrix(final Volume[][] data)
    {
        this(data, StorageType.DENSE);
    }
    ...
    /**
     * Construct a VolumeMatrix from a (sparse) collection of DoubleSparseValue objects. The displayUnit indicates the unit in
     ...
     * @param displayUnit VolumeUnit; the display unit of the matrix data, and the unit of the data points
     * @param rows int; the number of rows of the matrix
     * @param cols int; the number of columns of the matrix
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public VolumeMatrix(final Collection<DoubleSparseValue<VolumeUnit, Volume>> data, final VolumeUnit displayUnit,
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public VolumeMatrix(final Collection<DoubleSparseValue<VolumeUnit, Volume>> data, final int rows, final int cols,
