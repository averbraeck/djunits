...
public class FloatVolume extends FloatScalarRel<VolumeUnit, FloatVolume>
{
    ...
    /**
     * Construct FloatVolume scalar with a unit.
    ...
    /**
     * Construct FloatVolume scalar with a unit using a double value.
    ...
    /**
     * Construct FloatVolume scalar based on an SI value.
     * @param value the float value in SI units
     * @return the new scalar with the SI value
     */
    public static final FloatVolume ofSI(final float value)
    {
     ...
     * @return a FloatVolume at the given ratio between 0 and 1
     */
    ...
    public static FloatVolume of(final float value, final String unitString)
    {
        ...
        VolumeUnit unit = VolumeUnit.BASE.getUnitByAbbreviation(unitString);
        Throw.when(unit == null, IllegalArgumentException.class, "Error parsing FloatVolume with unit %s", unitString);
        return new FloatVolume(value, unit);
    }
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatVolume.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatVolume
     */
    public static FloatVolume multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type FloatVolume",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatVolume(scalar1.si * scalar2.si, VolumeUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatVolume.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatVolume
     */
    public static FloatVolume divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .minus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(VolumeUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type FloatVolume",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatVolume(scalar1.si / scalar2.si, VolumeUnit.SI);
    }
