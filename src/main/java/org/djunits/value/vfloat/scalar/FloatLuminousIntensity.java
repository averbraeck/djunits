...
public class FloatLuminousIntensity extends FloatScalarRel<LuminousIntensityUnit, FloatLuminousIntensity>
{
    ...
    /**
     * Construct FloatLuminousIntensity scalar with a unit.
    ...
    /**
     * Construct FloatLuminousIntensity scalar with a unit using a double value.
    ...
    /**
     * Construct FloatLuminousIntensity scalar based on an SI value.
     ...
     * @return a FloatLuminousIntensity at the given ratio between 0 and 1
     */
    ...
    public static FloatLuminousIntensity of(final float value, final String unitString)
    {
        ...
        LuminousIntensityUnit unit = LuminousIntensityUnit.BASE.getUnitByAbbreviation(unitString);
        Throw.when(unit == null, IllegalArgumentException.class, "Error parsing FloatLuminousIntensity with unit %s",
                unitString);
        return new FloatLuminousIntensity(value, unit);
    }
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatLuminousIntensity.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatLuminousIntensity
     */
    public static FloatLuminousIntensity multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(LuminousIntensityUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class,
                "Multiplying %s by %s does not result in instance of type FloatLuminousIntensity", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new FloatLuminousIntensity(scalar1.si * scalar2.si, LuminousIntensityUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatLuminousIntensity.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatLuminousIntensity
     */
    public static FloatLuminousIntensity divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(LuminousIntensityUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class,
                "Dividing %s by %s does not result in an instance of type FloatLuminousIntensity", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new FloatLuminousIntensity(scalar1.si / scalar2.si, LuminousIntensityUnit.SI);
    }
