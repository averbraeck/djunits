...
public class Mass extends Quantity.Relative<Mass, Mass.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Mass.Unit>
    {
        ...
        /** Gray. */
        public static final Mass.Unit GRAY = new Mass.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final Mass.Unit SI = GRAY;

        /** mGy. */
        public static final Mass.Unit MILLIGRAY =
                new Mass.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final Mass.Unit MICROGRAY =
                new Mass.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final Mass.Unit ERG_PER_GRAM =
                new Mass.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final Mass.Unit RAD = new Mass.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Mass.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
