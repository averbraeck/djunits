...
public class ElectricalCurrentMatrix
        extends DoubleMatrixRel<ElectricalCurrentUnit, ElectricalCurrent, ElectricalCurrentVector, ElectricalCurrentMatrix>

{
     ...
     * @param displayUnit ElectricalCurrentUnit; the display unit of the matrix data
     */
    public ElectricalCurrentMatrix(final DoubleMatrixData data, final ElectricalCurrentUnit displayUnit)
    {
    ...
    /**
     * Construct a ElectricalCurrentMatrix from a double[][] object. The double values are expressed in the displayUnit, and
     ...
     */
    public ElectricalCurrentMatrix(final double[][] data, final ElectricalCurrentUnit displayUnit,
    ...
    /**
     * Construct a ElectricalCurrentMatrix from a double[][] object. The double values are expressed in the displayUnit. Assume
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ElectricalCurrentMatrix(final double[][] data, final StorageType storageType)
    {
        this(data, ElectricalCurrentUnit.SI, storageType);
    }

    /**
     * Construct a ElectricalCurrentMatrix from a double[][] object with SI-unit values. Assume that the StorageType is DENSE
     * since we offer the data as an array of an array.
     * @param data double[][]; the data for the matrix, in SI units
     */
    public ElectricalCurrentMatrix(final double[][] data)
    {
    ...
    /**
     * Construct a ElectricalCurrentMatrix from an array of an array of ElectricalCurrent objects. The ElectricalCurrent values
     * are each expressed in their own unit, but will be internally stored as SI values, all expressed in the displayUnit when
     * printing.
     * @param data ElectricalCurrent[][]; the data for the matrix
     * @param displayUnit ElectricalCurrentUnit; the display unit of the values when printing
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ElectricalCurrentMatrix(final ElectricalCurrent[][] data, final ElectricalCurrentUnit displayUnit,
            final StorageType storageType)
    {
     ...
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ElectricalCurrentMatrix(final ElectricalCurrent[][] data, final StorageType storageType)
    {
        this(data, ElectricalCurrentUnit.SI, storageType);
    }
     ...
     * @param data ElectricalCurrent[][]; the data for the matrix
     */
    public ElectricalCurrentMatrix(final ElectricalCurrent[][] data)
    {
        this(data, StorageType.DENSE);
    }
    ...
    /**
     * Construct a ElectricalCurrentMatrix from a (sparse) collection of DoubleSparseValue objects. The displayUnit indicates
     ...
     * @param displayUnit ElectricalCurrentUnit; the display unit of the matrix data, and the unit of the data points
     * @param rows int; the number of rows of the matrix
     * @param cols int; the number of columns of the matrix
     * @param storageType StorageType; the StorageType (SPARSE or DENSE) to use for constructing the Matrix
     */
    public ElectricalCurrentMatrix(final Collection<DoubleSparseValue<ElectricalCurrentUnit, ElectricalCurrent>> data,
