...
public class FloatPower extends FloatScalarRel<PowerUnit, FloatPower>
{
    ...
    /**
     * Construct FloatPower scalar with a unit.
    ...
    /**
     * Construct FloatPower scalar with a unit using a double value.
    ...
    /**
     * Construct FloatPower scalar based on an SI value.
     ...
     * @return a FloatPower at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatPower.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatPower
     */
    public static FloatPower multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type FloatPower",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatPower(scalar1.si * scalar2.si, PowerUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatPower.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatPower
     */
    public static FloatPower divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .minus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(PowerUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type FloatPower",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatPower(scalar1.si / scalar2.si, PowerUnit.SI);
    }
