...
public class SolidAngle extends Quantity.Relative<SolidAngle, SolidAngle.Unit>
{
    ...
    public static class Unit extends AbstractUnit<SolidAngle.Unit>
    {
        ...
        /** Gray. */
        public static final SolidAngle.Unit GRAY = new SolidAngle.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final SolidAngle.Unit SI = GRAY;

        /** mGy. */
        public static final SolidAngle.Unit MILLIGRAY =
                new SolidAngle.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final SolidAngle.Unit MICROGRAY =
                new SolidAngle.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final SolidAngle.Unit ERG_PER_GRAM =
                new SolidAngle.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final SolidAngle.Unit RAD = new SolidAngle.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new SolidAngle.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
