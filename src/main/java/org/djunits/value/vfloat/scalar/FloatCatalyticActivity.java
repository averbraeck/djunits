...
public class FloatCatalyticActivity extends FloatScalarRel<CatalyticActivityUnit, FloatCatalyticActivity>
{
    ...
    /**
     * Construct FloatCatalyticActivity scalar with a unit.
    ...
    /**
     * Construct FloatCatalyticActivity scalar with a unit using a double value.
    ...
    /**
     * Construct FloatCatalyticActivity scalar based on an SI value.
     * @param value the float value in SI units
     * @return the new scalar with the SI value
     */
    public static final FloatCatalyticActivity ofSI(final float value)
    {
     ...
     * @return a FloatCatalyticActivity at the given ratio between 0 and 1
     */
    ...
    public static FloatCatalyticActivity of(final float value, final String unitString)
    {
        ...
        CatalyticActivityUnit unit = CatalyticActivityUnit.BASE.getUnitByAbbreviation(unitString);
        Throw.when(unit == null, IllegalArgumentException.class, "Error parsing FloatCatalyticActivity with unit %s",
                unitString);
        return new FloatCatalyticActivity(value, unit);
    }
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatCatalyticActivity.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatCatalyticActivity
     */
    public static FloatCatalyticActivity multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(
                ...
                "Multiplying %s by %s does not result in instance of type FloatCatalyticActivity", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new FloatCatalyticActivity(scalar1.si * scalar2.si, CatalyticActivityUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatCatalyticActivity.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatCatalyticActivity
     */
    public static FloatCatalyticActivity divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(CatalyticActivityUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class,
                "Dividing %s by %s does not result in an instance of type FloatCatalyticActivity", scalar1.toDisplayString(),
                scalar2.toDisplayString());
        return new FloatCatalyticActivity(scalar1.si / scalar2.si, CatalyticActivityUnit.SI);
    }
