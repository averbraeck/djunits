...
public class FlowMass extends Quantity.Relative<FlowMass, FlowMass.Unit>
{
    ...
    public static class Unit extends AbstractUnit<FlowMass.Unit>
    {
        ...
        /** mGy. */
        public static final FlowMass.Unit MILLIGRAY =
                new FlowMass.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);
        ...
        /** erg/g. */
        public static final FlowMass.Unit ERG_PER_GRAM =
                new FlowMass.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new FlowMass.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
