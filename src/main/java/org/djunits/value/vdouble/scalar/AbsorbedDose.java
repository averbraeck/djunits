...
public class AbsorbedDose extends DoubleScalarRel<AbsorbedDoseUnit, AbsorbedDose>
{
    ...
    /**
     * Construct AbsorbedDose scalar with a unit.
    ...
    /**
     * Construct AbsorbedDose scalar based on an SI value.
     ...
     * @return a AbsorbedDose at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type AbsorbedDose.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of AbsorbedDose
     */
    public static AbsorbedDose multiply(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .plus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(AbsorbedDoseUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type AbsorbedDose",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new AbsorbedDose(scalar1.si * scalar2.si, AbsorbedDoseUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type AbsorbedDose.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of AbsorbedDose
     */
    public static AbsorbedDose divide(final DoubleScalarRel<?, ?> scalar1, final DoubleScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(
                !scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                        ...
                        .equals(AbsorbedDoseUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type AbsorbedDose",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new AbsorbedDose(scalar1.si / scalar2.si, AbsorbedDoseUnit.SI);
    }
