...
public class Temperature extends Quantity.Relative<Temperature, Temperature.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Temperature.Unit>
    {
        ...
        /** Gray. */
        public static final Temperature.Unit GRAY = new Temperature.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final Temperature.Unit SI = GRAY;

        /** mGy. */
        public static final Temperature.Unit MILLIGRAY =
                new Temperature.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);

        /** &#181;Gy. */
        public static final Temperature.Unit MICROGRAY =
                new Temperature.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);

        /** erg/g. */
        public static final Temperature.Unit ERG_PER_GRAM =
                new Temperature.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final Temperature.Unit RAD = new Temperature.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Temperature.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
