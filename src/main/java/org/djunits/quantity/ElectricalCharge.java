...
public class ElectricalCharge extends Quantity.Relative<ElectricalCharge, ElectricalCharge.Unit>
{
    ...
    public static class Unit extends AbstractUnit<ElectricalCharge.Unit>
    {
        ...
        /** &#181;Gy. */
        public static final ElectricalCharge.Unit MICROGRAY =
                new ElectricalCharge.Unit(List.of("muGy"), "\u03BCGy", "microgray", new LinearScale(1.0E-6), UnitSystem.SI_DERIVED);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new ElectricalCharge.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
