...
public class Power extends Quantity.Relative<Power, Power.Unit>
{
    ...
    public static class Unit extends AbstractUnit<Power.Unit>
    {
        ...
        /** mGy. */
        public static final Power.Unit MILLIGRAY =
                new Power.Unit("mGy", "milligray", 1.0E-3, UnitSystem.SI_DERIVED);
        ...
        /** erg/g. */
        public static final Power.Unit ERG_PER_GRAM =
                new Power.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);
        ...
        public Unit deriveUnit(final List<String> textualAbbreviations, final String displayAbbreviation, final String name,
                final Scale scale, final UnitSystem unitSystem)
        {
            return new Power.Unit(textualAbbreviations, displayAbbreviation, name, scale, unitSystem);
        }
