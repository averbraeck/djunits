 ...
 */
public class FloatSparseValue<Q extends Quantity<Q>> implements Serializable
{
    /** */
     ...
     */
    public FloatSparseValue(final int row, final int column, final float valueInUnit, final UnitInterface<?, Q> unit)
    {
