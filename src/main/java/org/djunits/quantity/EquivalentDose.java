...
public class EquivalentDose extends Quantity.Relative<EquivalentDose, EquivalentDose.Unit>
{
    ...
    public static class Unit extends AbstractUnit<EquivalentDose.Unit>
    {
        ...
        /** Gray. */
        public static final EquivalentDose.Unit GRAY = new EquivalentDose.Unit("Gy", "gray", 1.0, UnitSystem.SI_DERIVED);

        /** The SI or BASE unit. */
        public static final EquivalentDose.Unit SI = GRAY;

        /** mGy. */
        public static final EquivalentDose.Unit MILLIGRAY =
        ...
        public static final EquivalentDose.Unit ERG_PER_GRAM =
                new EquivalentDose.Unit("erg/g", "erg per gram", 1.0E-4, UnitSystem.CGS);

        /** rad. */
        public static final EquivalentDose.Unit RAD = new EquivalentDose.Unit("rad", "rad", 1.0E-2, UnitSystem.CGS);
