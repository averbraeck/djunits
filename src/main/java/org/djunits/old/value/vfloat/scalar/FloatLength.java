...
public class FloatLength extends FloatScalarRelWithAbs<PositionUnit, FloatPosition, LengthUnit, FloatLength>
{
    ...
    /**
     * Construct FloatLength scalar with a unit.
    ...
    /**
     * Construct FloatLength scalar with a unit using a double value.
    ...
    /**
     * Construct FloatLength scalar based on an SI value.
     ...
     * @return a FloatLength at the given ratio between 0 and 1
     */
    ...
    /**
     * Multiply two scalars that result in a scalar of type FloatLength.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the multiplication of both scalars as an instance of FloatLength
     */
    public static FloatLength multiply(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        ...
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                ...
                IllegalArgumentException.class, "Multiplying %s by %s does not result in instance of type FloatLength",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatLength(scalar1.si * scalar2.si, LengthUnit.SI);
    }

    /**
     * Divide two scalars that result in a scalar of type FloatLength.
     * @param scalar1 the first scalar
     * @param scalar2 the second scalar
     * @return the division of scalar1 by scalar2 as an instance of FloatLength
     */
    public static FloatLength divide(final FloatScalarRel<?, ?> scalar1, final FloatScalarRel<?, ?> scalar2)
    {
        Throw.whenNull(scalar1, "scalar1 cannot be null");
        Throw.whenNull(scalar2, "scalar2 cannot be null");
        Throw.when(!scalar1.getDisplayUnit().getQuantity().getSiDimensions()
                .minus(scalar2.getDisplayUnit().getQuantity().getSiDimensions()).equals(LengthUnit.BASE.getSiDimensions()),
                IllegalArgumentException.class, "Dividing %s by %s does not result in an instance of type FloatLength",
                scalar1.toDisplayString(), scalar2.toDisplayString());
        return new FloatLength(scalar1.si / scalar2.si, LengthUnit.SI);
    }
