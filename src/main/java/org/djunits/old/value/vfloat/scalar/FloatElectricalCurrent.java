...
public class FloatElectricalCurrent extends FloatScalarRel<ElectricalCurrentUnit, FloatElectricalCurrent>
{
    ...
    /**
     * Construct FloatElectricalCurrent scalar with a unit.
    ...
    /**
     * Construct FloatElectricalCurrent scalar with a unit using a double value.
    ...
    /**
     * Construct FloatElectricalCurrent scalar based on an SI value.
     ...
     * @return a FloatElectricalCurrent at the given ratio between 0 and 1
     */
    ...
    public static FloatElectricalCurrent valueOf(final String text)
    {
        ...
        {
            throw new IllegalArgumentException("Error parsing FloatElectricalCurrent from " + text + " using Locale "
    ...
    public static FloatElectricalCurrent of(final float value, final String unitString)
    {
        ...
        ElectricalCurrentUnit unit = ElectricalCurrentUnit.BASE.getUnitByAbbreviation(unitString);
        Throw.when(unit == null, IllegalArgumentException.class, "Error parsing FloatElectricalCurrent with unit %s",
                unitString);
        return new FloatElectricalCurrent(value, unit);
    }
