...
public class VolumetricObjectDensity extends Quantity.Relative<VolumetricObjectDensity, VolumetricObjectDensity.Unit>
{
     ...
     * @author Alexander Verbraeck
     */
    public static class Unit extends AbstractUnit<VolumetricObjectDensity.Unit>
    {
                ...
                final double scaleFactor, final UnitSystem unitSystem)
        {
            ...
            {
                return new VolumetricObjectDensity.Unit(textualAbbreviations, displayAbbreviation, name,
