...

{
     ...
     * @param displayUnit FlowMassUnit; the display unit of the matrix data
     */
     ...
     * @param data FloatFlowMass[][]; the data for the matrix
     ...
     * @param displayUnit FlowMassUnit; the display unit of the matrix data, and the unit of the data points
