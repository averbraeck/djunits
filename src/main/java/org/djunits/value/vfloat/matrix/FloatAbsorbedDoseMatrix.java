...

{
     ...
     * @param displayUnit AbsorbedDoseUnit; the display unit of the matrix data
     */
     ...
     * printing.
     * @param data FloatAbsorbedDose[][]; the data for the matrix
     ...
     * @param displayUnit AbsorbedDoseUnit; the display unit of the matrix data, and the unit of the data points
