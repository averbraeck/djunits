                ...
                FloatTemperatureMatrix>
{
     ...
     * @param displayUnit TemperatureUnit; the display unit of the matrix data
     */
     ...
     * printing.
     * @param data FloatTemperature[][]; the data for the matrix
     ...
     * @param displayUnit TemperatureUnit; the display unit of the matrix data, and the unit of the data points
